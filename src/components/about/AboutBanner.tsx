    ...
    <section className="pt-32 pb-20 bg-gradient-to-br from-primary-900 to-primary-950 relative overflow-hidden">
      ...
      <Container className="relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            About <span className="bg-clip-text text-transparent bg-gradient-to-r from-accent-400 to-secondary-400">Aretex-ai</span>
          </motion.h1>
          ...
          >
            Driving innovation through technology. Learn about our mission, vision, 
