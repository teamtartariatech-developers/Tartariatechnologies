    ...
    <section className="pt-32 pb-20 bg-gradient-to-br from-primary-900 to-primary-950 relative overflow-hidden">
      ...
      <Container className="relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Client <span className="bg-clip-text text-transparent bg-gradient-to-r from-accent-400 to-secondary-400">Testimonials</span>
          </motion.h1>
          ...
          >
            ...
            Real stories from real companies we've helped transform.
          </motion.p>
        </div>
      </Container>
    </section>
